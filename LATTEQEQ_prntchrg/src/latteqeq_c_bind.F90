...
SUBROUTINE LATTEQEQ_C_BIND (FLAGS, NATS, COORDS, TYPES, NTYPES, MASSES, XLO, &
     ...
     VEL, DT, VIRIAL_INOUT, CURRENTSTEP, & 
     LOCALCHI, &
  ...
  !REAL(C_DOUBLE)                 ::  GRADX(NATS,NATS*3+1) NOTE JAMES CHANGED from this 5/16/23
  REAL(C_DOUBLE)                 ::  LOCALCHI(NATS)
  ...
  CALL LATTEQEQ(NTYPES, TYPES, COORDS, MASSES, XLO, XHI, XY, XZ, YZ, FORCES, &
       MAXITER, VENERG, VEL, DT, VIRIAL_INOUT, CURRENTSTEP, & 
       LOCALCHI, NEWSYSTEM, EXISTERROR)
